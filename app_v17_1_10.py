...
🪞 현자의 거울 스튜디오 — Master App v17.1.10

[v17.1.10 업데이트 사항: 2026-05-29]
- 팝업 어시스턴트 차단(리다이렉트 순간이동 및 몽키 패치) 로직 전면 제거
- 파트 0(젬마 스튜디오) 및 모든 파트(Part 1 ~ Part 8) 상단 우측에 popup_assistant() 기반 대화창 팝업 단추 원상 복구
- 배포 버전 app_v17_1_10.py 및 RUN_APP.bat 갱신 완료
...
from sage_popups_v17_1_10 import (
