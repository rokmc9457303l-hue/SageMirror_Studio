...
def render_right_gemma_panel():
    ...
    with ctrl_model:
        MODEL_MAP = {
            "Gemma E2B (로컬)": "gemma4:e2b",
            "Gemma E4B (로컬)": "gemma4:e4b",
