...
🪞 현자의 거울 스튜디오 — Master App v16.0.0

[v16.0.0 업데이트 사항: 2026-05-25]
- [A] 젬마 어시스턴트 팝업(popup_assistant) 내 Gemma 대화 스트리밍 처리 블록(pending_stream)에 References & 파일 RAG 메모리 자동 주입 구현
- [B] RAG 컨텍스트 메모리 로딩 최대 길이(max_chars) 30,000자 제한 적용 및 예외 처리
- [C] 실행 배치 및 스크립트 파일(RUN_APP.bat, RUN_DEBUG.bat, RUN_APP.vbs) 구동 대상을 app_v16_0_0.py로 통합 (포트 8505)
- [D] py_compile 컴파일 무오류 검증 완료
