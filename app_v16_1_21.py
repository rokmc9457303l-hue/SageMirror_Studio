...
PART_OBS_FOLDER_MAP = {
    ...
    "unlock_part1":          ("",               "Part1_잠금상태"),
    "unlock_part2":          ("",               "Part2_잠금상태"),
    "unlock_part34":         ("",               "Part34_잠금상태"),
    "unlock_part5":          ("",               "Part5_잠금상태"),
    "unlock_part6":          ("",               "Part6_잠금상태"),
    "unlock_part7":          ("",               "Part7_잠금상태"),
    "unlock_part8":          ("",               "Part8_잠금상태"),
