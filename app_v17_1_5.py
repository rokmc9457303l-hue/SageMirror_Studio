...
🧙 현자의 거울 스튜디오 — Master App v17.1.5

[v17.1.5 업데이트 사항: 2026-05-29]
- [젬마 어시스턴트 네이티브 채팅 UI 적용] st.chat_message, st.chat_input 적용으로 채팅창 개편
- [무한 로딩 및 타임아웃 차단] 초경량 프롬프트 주입 및 _stream_gemma_a_mode 제너레이터 구현
- [대화 증발 방지] popup_chat_EP001.json 에 실시간 영속성 저장 로직 강화
- [모드 선택 칩스] A모드/B모드 라디오 버튼으로 직관적 선택 기능 추가
...
from sage_popups_v17_1_5 import (
