...
def render_right_gemma_panel():
    ...
    if "right_auto_save_enabled" not in st.session_state:
        st.session_state.right_auto_save_enabled = True
    if "right_auto_save_status" not in st.session_state:
        st.session_state.right_auto_save_status = "대기"
    if "right_auto_save_last_time" not in st.session_state:
        st.session_state.right_auto_save_last_time = ""
    if "right_auto_save_retry_count" not in st.session_state:
        st.session_state.right_auto_save_retry_count = 0

    if "right_research_inbox" not in st.session_state:
        st.session_state.right_research_inbox = []
    if "right_research_status" not in st.session_state:
        st.session_state.right_research_status = "idle"
    if "right_research_last_request_id" not in st.session_state:
        st.session_state.right_research_last_request_id = ""
    if "right_research_last_error" not in st.session_state:
        st.session_state.right_research_last_error = ""
