...
🪞 현자의 거울 스튜디오 — Master App v15.9.16

[v15.9.16 업데이트 사항: 2026-05-23]

- 보안 위협 차단: 소스 코드 및 workspace_state.json 내 하드코딩된 API Key(Gemini 등) 완전 제거
- 보안 정보 로컬 격리: 중요 API Key(Gemini, Tavily, YouTube API Key) 및 GitHub PAT 토큰을 workspace_state.json 대신 로컬 격리 파일인 `local_secrets.json`에 분리 보관 처리
- .gitignore 연동으로 local_secrets.json의 GitHub 노출 원천 차단
