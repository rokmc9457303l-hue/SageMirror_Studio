...
- 팝업 모듈 sage_popups_v19_0_1_WORK.py 연결
- 실행 표시 버전명 정리
...
from sage_popups_v19_0_1_WORK import (

    popup_edit_obsidian, popup_edit_prompt, render_assistant_chat,
...
main_col, right_col = st.columns([7, 3], gap="large")
...
with right_col:
    # V19: render_assistant_chat() — 팝업 폐기, 상시 고정 대화창
    from sage_popups_v19_0_1_WORK import render_assistant_chat
