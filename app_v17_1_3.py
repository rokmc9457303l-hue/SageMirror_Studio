...
🪞 현자의 거울 스튜디오 — Master App v17.1.3

[v17.1.3 업데이트 사항: 2026-05-29]
- [응답 시간 계측] 젬마 어시스턴트 빠른 대화(A모드) 응답 및 저장 시간 계측 추가
- [모델/자료조사 분리] 자료 조사 탭 Gemini/Tavily 수집 및 Gemma 가공·분류·저장 프로세스 전면 개편
- [동적 import 적용] popup_edit_obsidian 및 popup_edit_prompt 내 모듈 동적 참조 적용
...
from sage_popups_v17_1_3 import (
...
def render_top_panel():
    st.caption("RUNNING VERSION: v17.1.3")
