...
🪞 현자의 거울 스튜디오 — Master App v16.1.5

[v16.1.5 업데이트 사항: 2026-05-26]
- Agent Layer Separation Phase 1 (Research Router 분리)
- Tavily 검색 및 NEED_RESEARCH 등 비-UI 검색 흐름을 research_router.py로 분리
- app_v16_1_5.py 내부 검색 관련 로직 위임 연동
