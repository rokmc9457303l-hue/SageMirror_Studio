...
🪞 현자의 거울 스튜디오 — Master App v17.1.11

[v17.1.11 업데이트 사항: 2026-05-29]
- 파트 0 (풀스크린 젬마 스튜디오) 3:7 분할 뼈대 레이아웃 완벽 구축 (좌: 지식 소스 파일/링크 추출, 우: 4종 모델/엔진 네이티브 대화창)
- 모든 파트 (Part 1 ~ Part 8) 우측 상단 어시스턴트 호출 단추를 파트 0으로 순간이동 리다이렉트하는 '🚀 젬마 스튜디오 입장' 버튼으로 전환
- 배포 버전 app_v17_1_11.py 및 RUN_APP.bat 갱신 완료
...
from sage_popups_v17_1_11 import (
