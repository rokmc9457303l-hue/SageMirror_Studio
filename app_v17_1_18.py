...
🪞 현자의 거울 스튜디오 — Master App v17.1.12

[v17.1.12 업데이트 사항: 2026-05-29]
- 파트 0 (풀스크린 젬마 스튜디오) 상단 우측에 popup_assistant() 기반 대화창 팝업 단추 원상 복구 및 토스트 안내 제거
- 파트 1 ~ 파트 8까지의 모든 우측 상단 어시스턴트 단추의 리다이렉션을 제거하고, 본연의 popup_assistant() 기반 대화창 팝업 기능으로 완벽 롤백 복구
- 배포 버전 app_v17_1_12.py 및 RUN_APP.bat 갱신 완료
...
from sage_popups_v17_1_18 import (
