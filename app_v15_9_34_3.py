...
🪞 현자의 거울 스튜디오 — Master App v15.9.34.3

[v15.9.34.3 업데이트 사항: 2026-05-24]
- render_top_panel() 내부 text_area 위젯 Streamlit 경고(value와 key 동시 지정) 수정
...
def render_top_panel():
    ...
    with st.expander("📋 상단 공통: 옵시디언 규칙서 및 마스터 프롬프트", expanded=False):
        ...
        with R:
            ...
            st.text_area("파트 마스터 프롬프트", height=180, key=f"top_pr_view_{prompt_key}_widget", label_visibility="collapsed")
