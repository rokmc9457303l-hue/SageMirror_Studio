...
def _stream_gemma_a_mode_p0(prompt: str, system: str = "", model: str = "gemma4:e2b"):
    ...
    try:
        in_thinking = False
        with _req.post(ollama_url, json=payload, stream=True, timeout=(10, 180)) as resp:
            resp.raise_for_status()
...
def render_right_gemma_panel():
    ...
    /* Streamlit 내부 scroll container의 overflow 제한 해제 */
    ...
    with ctrl_model:
        MODEL_MAP = {
            ...
            "Tavily 웹검색": "Tavily 웹 검색",
        }
        selected_mode_display = st.selectbox("엔진", list(MODEL_MAP.keys()), key="right_gemma_model_select", label_visibility="collapsed")
    ...
    if send_clicked and user_input.strip():
        ...
        with chat_container.chat_message("assistant"):
            ...
            if new_model_id == "tavily":
                ...
                with st.spinner("로컬 모델을 준비하고 있습니다. 최초 실행은 최대 2분 정도 걸릴 수 있습니다."):
