...
new_p = Path(r"C:\SageMirror_Production\V17_Working_RightChat_011\app_v17_2_3.py")
diff_p = Path(r"C:\SageMirror_Production\rightchat_009_vs_011_scroll_diff.txt")
