...
🪞 현자의 거울 스튜디오 — Master App v17.1.4-B

[v17.1.4-B 업데이트 사항: 2026-05-29]
- [속도 최적화] 젬마 빠른 대화(A모드) keep_alive + num_predict 최적화 적용
- [옵션 시각화] 성능 진단 로그에 num_predict, keep_alive 표시 추가
...
from sage_popups_v17_1_4B import (
...
def render_top_panel():
    st.caption("RUNNING VERSION: v17.1.4-B")
