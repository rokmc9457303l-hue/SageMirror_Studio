...
🪞 현자의 거울 스튜디오 — Master App v15.9.34.13

[v15.9.34.13 업데이트 사항: 2026-05-25]
- [A] 상단 공통 프롬프트 및 옵시디언 규칙서 저장 시 HTML 오염 정화 로직(clean_prompt_contamination) 강화
- [B] load_workspace_state() 호출 시 14개 주요 키에 대해 정화 필터 적용
- [C] 앱 초기화 루틴(init_session_state)에서 session_state에 로드된 14개 주요 키 1회 정화 및 자동 저장 적용
- [D] sage_popups.py의 save_workspace_state 임포트 경로를 최신 버전(app_v15_9_34_13)으로 업데이트
