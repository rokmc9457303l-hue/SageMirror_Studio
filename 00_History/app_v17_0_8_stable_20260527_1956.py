...
🪞 현자의 거울 스튜디오 — Master App v17.0.8

[v17.0.8 업데이트 사항: 2026-05-27]
- popup_assistant 내 Gemma 에이전트 응답 스트리밍을 모든 반복(iteration)에 실시간 적용
- RAG 탐색 범위 및 버퍼 용량 한계 축소를 통한 로컬 성능 병목 완화 (max_files=10, max_chars=30000)
