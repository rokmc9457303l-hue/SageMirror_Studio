...
🪞 현자의 거울 스튜디오 — Master App v16.1.9

[v16.1.9 업데이트 사항: 2026-05-26]
- Part 2 Step 1 Persistent Memory Recovery Patch (영속성 복구 패치)
- 젬마 프로토콜, 썸네일 카드(세트, 선택 썸네일) 세션 및 파일 저장 누락 복구
