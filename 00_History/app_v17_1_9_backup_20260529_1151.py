...
🪞 현자의 거울 스튜디오 — Master App v17.1.9

[v17.1.9 업데이트 사항: 2026-05-29]
- 파트 0 (풀스크린 젬마 스튜디오) 최상단의 거추장스럽고 무의미했던 '[🤖 젬마 어시스턴트]' 팝업 버튼 로직 완전 적출
- 파트 0 상단 헤더 레이아웃을 7:3 (타이틀 : PIN 입력 창)의 깔끔한 2열 레이아웃으로 변경
- 배포 버전 app_v17_1_9.py 및 RUN_APP.bat 갱신 완료
...
def render_part0_assistant():
    ...
    # 1. 최상단 2열 레이아웃 (쓸데없는 팝업 버튼 완전 제거)
