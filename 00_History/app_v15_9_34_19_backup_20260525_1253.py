...
🪞 현자의 거울 스튜디오 — Master App v15.9.34.19

[v15.9.34.19 업데이트 사항: 2026-05-25]
- [A] References 폴더의 최신 md 파일들을 안전하게 읽어오는 load_recent_reference_files() 함수 추가 (최대 20개, 누적 120,000자 제한)
- [B] 메인 페이지 하단 개발자 테스트 UI에 "📖 References 로드 테스트" 수동 버튼 컴포넌트 추가
- [C] sage_popups.py의 save_workspace_state 임포트 경로를 최신 버전(app_v15_9_34_19)으로 업데이트
- [D] RUN_APP.bat 및 RUN_DEBUG.bat 실행 대상을 app_v15_9_34_19.py로 변경
