...
🪞 현자의 거울 스튜디오 — Master App v15.9.11

[v15.9.11 업데이트 사항: 2026-05-23]

- Gemini 2.5 Flash (Google Search Grounding) 실시간 검색 연동 (Tavily 폴백 포함)

- 조사 내용 옵시디언 자동 저장 기능 추가 (ResearchMemory 폴더)

- 최상단 상황판 5열 확장 및 "리서치 자동저장" 제어/확인 글래스모피즘 카드 추가

- 공통 옵시디언 규칙서 옆에 실시간 리서치 검색어 입력창 및 💾 즉시 저장 UI 버튼 탑재
...
def render_top_panel():
    ...
    with st.expander("📋 상단 공통: 옵시디언 규칙서 및 마스터 프롬프트", expanded=False):
        ...
        with L:
            ...
            research_cols = st.columns([3.0, 1.2])
