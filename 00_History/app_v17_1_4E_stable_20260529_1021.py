...
🧙 현자의 거울 스튜디오 — Master App v17.1.4-E

[v17.1.4-E 업데이트 사항: 2026-05-29]
- [A모드 응답 화면 표시 해결] @st.dialog 팝업 내스트리밍 현실적 업데이트 작동 안 함 해결
- [sage_engine.call_gemma 동기 호출] /api/generate 스트리밍 제거, 동기 호출 후 st.rerun()으로 화면 갱신
- [단순화] _call_gemma_fast_a_mode를 sage_engine.call_gemma 래퍼로 교체
...
from sage_popups_v17_1_4E import (
