...
🪞 현자의 거울 스튜디오 — Master App v15.9.34.7

[v15.9.34.7 업데이트 사항: 2026-05-24]
- RAG_CATEGORY_MAP 기반 자동 카테고리 감지 함수 추가
- 파트별 태그 자동 부여 및 TagIndex 연결 저장 함수 추가
- RAG 검색 저장물에 자동 분류/태그 섹션 반영
