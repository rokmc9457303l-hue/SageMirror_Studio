...
🪞 현자의 거울 스튜디오 — Master App v15.9.34.18

[v15.9.34.18 업데이트 사항: 2026-05-25]
- [A] References 폴더에 md 파일을 안전하게 UTF-8로 저장하는 save_reference_markdown_file() 함수 추가
- [B] 메인 페이지 하단 개발자 테스트 UI에 "📥 References 저장 테스트" 수동 버튼 컴포넌트 추가
- [C] sage_popups.py의 save_workspace_state 임포트 경로를 최신 버전(app_v15_9_34_18)으로 업데이트
- [D] RUN_APP.bat 및 RUN_DEBUG.bat 실행 대상을 app_v15_9_34_18.py로 변경
