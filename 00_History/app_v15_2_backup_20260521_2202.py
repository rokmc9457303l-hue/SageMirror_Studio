# -*- coding: utf-8 -*-
"""
🪞 현자의 거울 스튜디오 — Master App v15.2
[v15.2 업데이트 사항: 2026-05-21]
- 상단 동기화 및 연동 상태 패널을 하단 실시간 상황판과 동일한 테두리 및 배경 디자인(네모 박스)으로 통합하여 UI 일관성 강화 (사용자 요청 반영)
"""
...
def render_top_panel():
    ...
    /* 큰 박스 내부의 RAG 및 Git 버튼 디자인 통일화 (배경을 투명화 및 테두리 연화) */
    .clickable-card-wrapper button {
    ...
    .sync-btn-container button:hover {
