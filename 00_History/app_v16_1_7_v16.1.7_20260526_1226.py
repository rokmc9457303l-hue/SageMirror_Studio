...
🪞 현자의 거울 스튜디오 — Master App v16.1.7

[v16.1.7 업데이트 사항: 2026-05-26]
- Agent Registry System (에이전트 레지스트리 도입)
- Gemma Assistant가 사용할 수 있는 에이전트 도구들을 중앙 Registry로 통합
- agent_registry.py 신규 추가 및 agent_toolkit.py / sage_popups.py 연동
