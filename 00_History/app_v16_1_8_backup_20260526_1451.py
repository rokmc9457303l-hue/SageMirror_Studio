...
🪞 현자의 거울 스튜디오 — Master App v16.1.8

[v16.1.8 업데이트 사항: 2026-05-26]
- Gemma Assistant Stabilization Phase (에이전트 시스템 안정화)
- 도구 권한 체크, 에이전트 복구/폴백(Recovery/Fallback) 강화
- Recent Activity 중복 제거 및 리서치 이력 장애 시 RAG Fallback 보존
