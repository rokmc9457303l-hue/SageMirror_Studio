...
🪞 현자의 거울 스튜디오 — Master App v15.9.34.20

[v15.9.34.20 업데이트 사항: 2026-05-25]
- [A] 7차 로드 결과를 젬마 주입용 프롬프트 블록으로 가공하는 build_gemma_memory_prompt_preview() 함수 추가 (최대 30,000자 제한)
- [B] 메인 페이지 하단 개발자 테스트 UI에 "🧠 Gemma Memory Prompt 미리보기" 수동 버튼 컴포넌트 추가
- [C] sage_popups.py의 save_workspace_state 임포트 경로를 최신 버전(app_v15_9_34_20)으로 업데이트
- [D] RUN_APP.bat 및 RUN_DEBUG.bat 실행 대상을 app_v15_9_34_20.py로 변경
