...
🪞 현자의 거울 스튜디오 — Master App v17.0.0

[v17.0.0 업데이트 사항: 2026-05-27]
...
def render_part6_video():
    ...
    with st.expander("[VIDEO] 젬마 프로토콜 v2.0 — 영상 파트 전용 (클릭하여 확인/편집)", expanded=False):
        ...
        new_proto = st.text_area("영상 젬마 프로토콜 v2.0", value=st.session_state.p6_gemma_protocol, height=180, key="p6_protocol_ta", disabled=True)
