@echo off
title Sage Mirror Studio v13.2 (Video Edition)
...
echo ========================================
echo  Sage Mirror Studio v13.2
echo  Python: C:\Python314\python.exe
echo  App Ver: app_v13_2.py
...
"%PYTHON%" -m streamlit run app_v13_2.py --server.port 8501 --server.headless false
