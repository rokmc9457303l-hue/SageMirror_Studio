@echo off
title Sage Mirror Studio v8.2 (Design Edition)
...
echo ========================================
echo  Sage Mirror Studio v8.2
echo  Python: C:\Python314\python.exe
echo  App Ver: app_v8.py
...
"%PYTHON%" -m streamlit run app_v8.py --server.port 8501 --server.headless false
