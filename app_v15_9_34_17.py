...
🪞 현자의 거울 스튜디오 — Master App v15.9.34.17

[v15.9.34.17 업데이트 사항: 2026-05-25]
- [A] 8개 파트의 RAG 태그를 통합하여 반환하는 build_all_parts_common_tags_preview() 함수 추가
- [B] 메인 페이지 하단 개발자 테스트 UI에 "🌐 전체 8파트 공용 태그 미리보기" 컴포넌트 추가
- [C] sage_popups.py의 save_workspace_state 임포트 경로를 최신 버전(app_v15_9_34_17)으로 업데이트
- [D] RUN_APP.bat 및 RUN_DEBUG.bat 실행 대상을 app_v15_9_34_17.py로 변경
