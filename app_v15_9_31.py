...
def call_gemma(prompt, system="", model=None):
    ...
    try:
        ...
        if _rules and res and len(res) > 100:
            ...
            _vr1["is_pass"] = (_vr1.get("status", "PASS") == "PASS")
            _vr1["fix_suggestions"] = _vr1.get("suggestions", "")
            ...
            if not _pass1:
                ...
                _vr2["is_pass"] = (_vr2.get("status", "PASS") == "PASS")
                _vr2["fix_suggestions"] = _vr2.get("suggestions", "")
