...
🧙 현자의 거울 스튜디오 — Master App v17.1.6

[v17.1.6 업데이트 사항: 2026-05-29]
- [채팅 증발 버그 원천 차단] 팝업 다이얼로그 내부 st.rerun() 및 pending_stream 완전 제거
- [표준 네이티브 채팅 패턴 적용] st.chat_input 호출 즉시 화면을 갱신하는 Streamlit 표준 채팅 루프 구현
...
from sage_popups_v17_1_6 import (
