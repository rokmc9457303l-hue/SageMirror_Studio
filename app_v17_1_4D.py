...
🧙 현자의 거울 스튜디오 — Master App v17.1.4-D

[v17.1.4-D 업데이트 사항: 2026-05-29]
- [A모드 sys_ctx 초경량화] 시스템 프롬프트 200자 이내로 입력 토큰 최소화
- [/api/generate 전환] stream=True 스트리밍 방식으로 HTTP 타임아웃 원천 차단
- [num_predict 상향] 기본값 40 → 150으로 상향, 선택 UI 업데이트
- [thinking 폴백 제거] 빈 응답 시 오류 메시지 직접 반환
...
from sage_popups_v17_1_4D import (
