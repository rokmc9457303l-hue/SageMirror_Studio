...
🪞 현자의 거울 스튜디오 — Master App v15.9.34.4

[v15.9.34.4 업데이트 사항: 2026-05-24]
- render_top_panel() 상단 공통 프롬프트 저장/팝업 동기화 안정화
- popup 저장 시 위젯 key 직접 수정 금지, 다음 실행 동기화 플래그 방식 적용
    ...
    with c1:
        ...
        if st.button("💾 저장 및 닫기", type="primary", use_container_width=True, key=f"popup_edit_val_save_{session_key}"):
            ...
            if session_key == "obsidian_rules":
                ...
                st.session_state[f"_sync_top_pr_view_{session_key}_widget_next_run"] = True
